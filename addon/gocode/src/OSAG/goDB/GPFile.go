...
// GPFile.go
//
// Interface for reading and writing to column files. Data compression and
// decompression is handled by this interface.
//
...
const BUF_SIZE = 4096        // 512 * 64bit
const N_ELEM   = BUF_SIZE/8  // 512
